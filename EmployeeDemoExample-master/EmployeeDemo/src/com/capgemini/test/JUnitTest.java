...
public class JUnitTest {
	...
	public void whenEmployeeAddressIsNullForCreationOfEmployeeThenSystemShouldThrowAnException() {
		employeeService.createEmployee(105, "Rajat", null);
	}
	...
	public void whenEmployeeAddressLineIsNullForCreationOfEmployeeThenSystemShouldThrowAnException() {
		City delhi = new City("Delhi");
		Country india = new Country("India",delhi);
		employeeService.createEmployee(105, "Rajat", new Address(null,india));
	}
...
//	}
	 ...
	 * 2.When There is no employee of that name
	 * 3.When Employee name is correct
	 */
	...
	@Test(expected=com.capgemini.exception.NameNotFoundException.class)
	public void whenThereIsNoEmployeeOfThatNamePresentInDatabaseThenSystemShouldThrowAnException() {
		employeeService.searchByName("Raman");
	}
